...
const TokenScreen = () => {
  ...
  const handleBuy = async () => {
    ...
    try {
      const tx = await contract.javICO.invest({
    ...
    <div className="flex flex-col md:flex-row">
      <div className="flex justify-center items-center w-full">
        ...
        <div className="flex flex-col w-full items-center">
          ...
          <TokenDetails title="Name" value="JavierCoins Token" />
          <TokenDetails title="Symbol" value="JAV" />
          <TokenDetails title="Decimals" value="18" />

          <TokenDetails title="Total Supply" value={millify(4000)} />
          <TokenDetails title="Maximum Supply" value={millify(4000)} />
          <TokenDetails
            title="Token Address"
            value="0xc25CEE5F1DDc30f462D5AD2781Eb136Af5cf8CAe"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center items-center w-full flex-col">
        ...
        >
          <div className="card-container">
            ...
            <div>JAV : {icoState.investorBalance} JAV</div>
          </div>
        </div>
